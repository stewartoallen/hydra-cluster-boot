...
var render = {
    "task" : function(res, query, cluster, host) {
        http.template(res, query.funcName, {
            common_opt: cluster.config.default.cmdline
        });
    },
    ...
    "start-mesh" : function(res, query, cluster, host) {
        http.template(res, query.funcName, {
            common_opt: cluster.config.default.cmdline,
    ...
    "start-spawn" : function(res, query, cluster, host) {
        http.template(res, query.funcName, {
            common_opt: cluster.config.default.cmdline,
    ...
    "start-minion" : function(res, query, cluster, host) {
        http.template(res, query.funcName, {
            common_opt: cluster.config.default.cmdline,
    ...
    "start-qmaster" : function(res, query, cluster, host) {
        http.template(res, query.funcName, {
            common_opt: cluster.config.default.cmdline,
    ...
    "start-qworker" : function(res, query, cluster, host) {
        http.template(res, query.funcName, {
            common_opt: cluster.config.default.cmdline,
